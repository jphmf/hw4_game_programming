...
public:
    ...
    map<CollidableObject*, set<CollidableObject*>> spriteToSpriteCollisionsThisFrame;
    ...
    void addWinEventCollision(CollidableObject *dynamicObject, Tile *tile, float tileX, float tileY, float tileWidth, float tileHeight);
